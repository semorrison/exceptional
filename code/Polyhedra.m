...
Union[Together[ApplyAdjacentSquaresRelation[adjacentSquaresRelation][p55554444/.PolyhedraNames]]]


AddDiagramReduction[{1,0,1,1,5}][ApplyAdjacentSquaresRelation[adjacentSquaresRelation]]


FindNewPolyhedronEvaluationRule[{1,0,1,1,5}][p55554444]


FindNewPolyhedronEvaluationRule[{1,0,1,1,5}][p444444666]


FindNewPolyhedronEvaluationRule[{1,0,1,1,5}][p444455556]


innerProducts5=Together[Outer[InnerProduct,Take[DiagramsWithoutAdjacentSquares[5,_<=2],17],Take[DiagramsWithoutAdjacentSquares[5,_<=2],17]]/.PolyhedraEvaluationRules[{1,0,1,1,5}]]
