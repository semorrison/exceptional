...
\item If $\lambda$ is one of the special values in
  ...
  $\mathsf{Exc}^D_{\mathbb{C},\lambda}$ by the negligible elements is
...
\DPTtodo{Can we elucidate difference between
  Conjecture~\ref{conj:Deligne} and
  Conjecture~\ref{conj:class-consist}?}
...
\begin{remark}
  ...
  hold while the classical conjectures are false.
\end{remark}
...
\DPTtodo{This needs more explanation. Check these eigenvalues vs $b=12$}
...
$w = e^{\lambda h/2}$ in addition to $v = e^{h/2}$.
