...
\NStodo{We should change $6$ to $12$}
...
\NStodo{Move to special values, add quantum version.  Discuss reference with Pavel.}
...
\begin{corollary}[Quantum specialization]
...
\NStodo{Make ``quantum versions" more precise in special values section, add a forward pointer}
