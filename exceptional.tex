...
diagrams is expect to be infinite dimensional.

In addition, indpendently Cvitanovic and Vogel observed that the adjoint representations
...
So long as a certain finite set of polynomials in $b$ and $d$ are invertible, $\mathrm{Exc}_{R,b,d}$ has a finite dimensional space of $n$-boundary point diagrams for every $n$, and a $1$-dimensional space of $0$-boundary point diagrams.  
\end{conjecture}
