...
\neq 1$.  Then $\widetilde{\Phi}_8 = \{2\}$, $\alpha$, and $b+[3]\alpha$ are
...
\{\lambda+2\}\{\lambda-3\}\widetilde{\Phi}_3$ these relations are identical to
...
\frac{\widetilde{\Phi}_{12}}{v^4-1+v^{-4}}$ which is non-zero since is not a
