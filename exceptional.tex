...
There exists
  ...
  \item a category $\mathsf{Except}_{R,\lambda}$ where the objects are integers and morphism spaces are finite-dimensional free $R$-modules \NStodo{This doesn't actually follow from our conjectures!  Fix something.}
