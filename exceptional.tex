...
\begin{theorem}[Vogel]
  ...
  \]
\end{theorem}
\DPTtodo{Explain why we name the groups the way we do. Want to restrict to
...
\begin{remark}
  ...
  \item\label{item:eigenvalues} The two non-trivial eigenvalues $\alpha$ and $\beta$ of the ladder
    ...
    \]
    With vertices normalized as above, $\alpha = -\mu$ and
    $\beta = 1+\mu$.
...
\DPTtodo{Formulate the two conjectures: consistency and sufficiency of
  the relations}
