...
Work of Deligne, Cvitanovic, Vogel, and others, can be summarised as a
...
adjoint representation theories of $\mathfrak{sl}_2$, $\mathfrak{sl}_3$,
...
relation has a finite dimensional space of $n$-boundary point diagrams for
every $n$, and in particular a
...
diagrams, while the existence conjecture says that this evaluation is well-
defined (i.e. independent of choices along the way). Although both conjectures
