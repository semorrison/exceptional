...
\begin{table}
  ...
  \begin{tabular}{ccccccccc}
    \toprule
    &&&\multicolumn{5}{c}{$\beta_6$ and $\rho_6^4 \beta_6 \rho_6^{-4}$ eigenvalues} \\ \cmidrule(l){4-8}
   $\Tw_3$ & Mult & $v^{12}$ & $-v^{-6}$ & $-1$ & $w^2$ & $v^2w^{-2}$ \\
    \midrule
   $v^{36}$        & $1^2$ & - & 1 & - & - & - \\[2pt]
   $v^{24}$        & $5^2$ & 1 & 1 & 1 & 1 & 1 \\[2pt]
   $v^{12}$        & $4^2$ & - & 1 & 1 & 1 & 1 \\[2pt]
   $v^{12}w^4$     & $3^2$ & - & 1 & 1 & 1 & - \\[2pt]
   $v^{16}w^{-4}$  & $3^2$ & - & 1 & 1 & - & 1 \\[2pt]
   $1$             & $1^2$ & - & - & 1 & - & - \\[2pt]
   $w^{12}$        & $1^2$ & - & - & - & 1 & - \\[2pt]
   $v^{12}w^{-12}$ & $1^2$ & - & - & - & - & 1 \\[2pt]
   $v^4$           & $3^2$ & - & - & 1 & 1 & 1 \\[2pt]
...
set of representatives of the irreducible representation of the 6-box space under multiplication.

We can compute the quantum dimensions of these idempotents, as
...
and one can check that upon setting $v=1$ (achieved by replacing $[k\lambda+l]$ with $k\lambda+l$) these agree
