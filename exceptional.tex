...
There exists
  ...
  \item a \DPTtodo{rigid symmetric monoidal?}category
...
\DPTtodo{These can't be ``main results''}
...
\DPTtodo{Make another conjecture parallel to Deligne's conjecture,
  since this is what classical $\Rightarrow$ quantum actually shows}
...
\begin{lemma} \label{lem:constants}
  ...
  \DPTtodo{Does $s$ here agree with earlier conventiones?}
  \begin{equation}
