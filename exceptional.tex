...
\NStodo{Figure out where this should go.  Discuss reference with Pavel.}
...
\NStodo{We can prove this as in the classical case using Doplicher-Roberts.  Again discuss reference with Pavel.}
