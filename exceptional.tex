...
\begin{proposition}
Suppose $\cC$ satisfies QEJacobi for some $v$ and $\alpha$ with $v$ not a 12th root of unity, then the following equations hold.
...
Now take QESquare relation and subtract its 90-degree rotation, yielding:
