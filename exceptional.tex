...
\begin{align*}
  ...
  \Psi_7 & = v^6 + v^4 + v^2 + 1 + v^{-2} + v^{-4} + v^{-6} &
  \Psi_8 & = v^4 + v^{-4} \\
  \Psi_{12} & = v^4 + 1 + v^{-4} & \Psi_{24} & = v^4 - 1 + v^{-4}
\end{align*}
...
\begin{lemma}
$SO(3)_q$ satisfies three instances of the QEJacobi relation with $\alpha = -b \frac{\Psi_1}{\Psi_{24}} $ for $v$ a cube root of $q^{-1}$.  Under the change of variables we see that this value of $\alpha$ corresponds to $w = \pm v^4$ or $w = \pm v^{-3}$.
\end{lemma}
