...
\DPTtodo{This equation was wrong and I fixed it. I would also like a
  version with the classical $\lambda$ to appear}
\begin{equation}
...
\section{From classical to quantum conjecture}
\label{sec:classical-quantum}

We now show that a version of Conjecture~\ref{conj:classical} implies
a version of Conjecture~\ref{conj:quant-consist}.
