...
multiples of the trivalent vertex.  Finally if 

Similarly, if $2$, $3$, $\lambda-3$, $\lambda-2$, 
$\lambda-1$, $\lambda$, $\lambda+1$, $\lambda+2$, 2\lambda+1, 2\lambda+4$
...
\nn{all the big knots have answers that are too big.. maybe delete this para}
...
\nn{Compare to Mironov--Mkrtchyan--Morozov \cite{MR3491191} (which does the 2- and 3-strand torus knots),
  Westbury \cite{1510.08307} (which talks about the quantised Vogel plane,
  and in particular calculations for the $(2,n)$ torus knots) and Mironov--Morozov \cite{MR3475991} (which does all arborescent links?) \dots}
