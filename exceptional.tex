...
\begin{theorem}
Suppose $(\cC, X, \tau)$ is a trivalent ribbon category with $\dim{\cC_4} \leq 5$, and further suppose that $d$, $b$,$[6]$, and $[5]$ are invertible.  Then $\widetilde{\Phi}_8 = \{2\}$, $\alpha$, and $b+[3]\alpha$ are also invertible, and we have the following relations:
