...
invariant.
\item Deligne's classical exceptional series, generators and relations and 
conjectures.
...
series is sensible --- it is picked out as the unique braided tangle category
with ...
...
\item Specializations, including the 7-dimensional representation of $G_2$.
\end{enumerate}
\item Calculations
\begin{enumerate}
...
\item Knot polynomial calculations. Mention Westbury's paper, and the other
paper that has done some knot polynomial calculations.
\item Dimensions of irreducible objects.
\end{enumerate}
\item A Kontsevich integral argument
...
There are two main 2-variable knot polynomials: the HOMFLY-PT polynomial and the Kauffman polynomial.  The first of these interpolates between the Reshetikhin--Turaev invariants of 
