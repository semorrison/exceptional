...
\begin{figure}
  \caption{Local relations}
  \label{fig:local-relations}
\end{figure}
\begin{proof}
  First, we have several relations that automatically hold true
  locally:
\DPTtodo{Add local relations: unknot; framing change; vertex framing
  change. Use the \texttt{hobby} package.}
  \begin{align*}
    \ngon{2}\;&= b\;\nvertex{2}&
      \ngon{3}\; &= t\;\nvertex{3}
  \end{align*}
...
\DPTtodo{Picture: cycle three of the strands}
