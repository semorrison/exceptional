...
\newcommand{\drawdottedH}{ \begin{tikzpicture}[baseline=-0.5ex,scale=0.8]
        \draw (45:.8cm) -- (-45:.8cm);
...
\newcommand{\drawcup}{\begin{tikzpicture}[baseline=-0.5ex,scale=0.8]
...
\newcommand{\invbraidcross}{\begin{tikzpicture}[baseline=-0.5ex,scale=0.8]
	\draw (-45:.8cm) -- (135:.8cm);
	\draw[line width=1mm,white,double=black] (45:.8cm) -- (-135:.8cm);
\end{tikzpicture}}
...
\newcommand{\drawsymcrossX}{ \begin{tikzpicture}[baseline=-0.5ex,scale=0.8,rotate=90]
 	\draw ([out angle=30].2,.3) .. (45:.8cm);
	\draw (.2,.3) -- (.2,-.3);
 	\draw ([out angle=-30].2,-.3) .. (-45:.8cm);
        \draw ([out angle=-150].2,-.3) ..([in angle=-70]135:.8cm);
